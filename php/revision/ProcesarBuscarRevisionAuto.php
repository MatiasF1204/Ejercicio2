...
// Consulta más resumida usando alias
$sql = "SELECT r.cod_revision, r.fingreso, r.fegreso,
       r.estado, r.cambio_filtro, r.cambio_aceite,
       r.cambio_freno, r.descripcion,
       a.marca, a.modelo
        FROM revision r
        INNER JOIN auto a ON r.cod_auto = a.cod_auto
        WHERE a.cod_auto = '$cod_auto'
    ";
...
<body>
    ...
    <?php else: ?>
        <p>No hay revisiones registradas para ese auto.</p>
    <?php endif ?>
    <br>
